...
## &#128204; Дз 5 по инженерным практикам в ML

- [x] Прописать в readme как запускать ваш пайплайн (3 балла).


- [x] Реализовать CLI для своих экспериментов (3 балла) - за счет Makefile


```sh
make all запускает пайп (format, lint)

make format (isort)
make lint (flake8, black)

make setup (poetry install --no-root, poetry check)
...
## &#128204; Дз 4 по инженерным практикам в ML
